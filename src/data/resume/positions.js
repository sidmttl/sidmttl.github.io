const positions = [
  {
    ...
    link: 'https://www.plm.automation.siemens.com/global/en/industries/automotive-transportation/autonomous-vehicles.html',
    daterange: 'June 2021 - August 2021',
    points: [
      'Performed literature review of traffic trajectory prediction and microscopic traffic simulation',
      'mplemented Polynomial and Deep Learning models to regress traffic trajectories collected from SUMO (Simulation of Urban MObility).',
      'Generated trajectories from private video data of Indian traffic, using faster R-CNN Optimized on KITTI vehicle dataset.',
    ],
  },
  {
